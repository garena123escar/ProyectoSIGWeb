...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean" style="border-bottom-style: solid;">
        <div class="container"><a class="navbar-brand" href="MapaViol.php" >CityReporte</a><a class="navbar-brand" href="index.php" style="height: 39px;margin: -7px;padding: 6px;width: 50px;color: rgba(255,0,0,0.9);filter: brightness(200%);">Salir</a>
        </div>
    </nav>
    ...
    <script>
        ...
        var ImmediateSubAction = L.Toolbar2.Action.extend({
                ...
                options: {
                    toolbarIcon: {
                        html: 'Visualizar Reportes de Violencia',
                        tooltip: 'Go to the Eiffel Tower'
                    }
                },
                addHooks: function() {
                      var flag_clustter=false;
                    alert( "A continuación se muestran los reportes más recientes de tipo violencia:" );
    ...
    //funcion para visualizar noticias del dia
        ...
        function cargarClustert()
        {
            $.post("src/funciones.php",
                {
                    peticion: 'recupera-geojson-cluster-Violencia'
                },
