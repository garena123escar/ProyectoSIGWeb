...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean" style="border-bottom-style: solid;">
        <div class="container"><a class="navbar-brand" href="MapaViz.php" style="border-style: none;border-bottom-style: none;">CityReporte</a><a class="navbar-brand" href="index.php" style="height: 39px;margin: -7px;padding: 6px;width: 50px;color: rgba(255,0,0,0.9);filter: brightness(200%);">Salir</a>
            </div>
        </div>
    </nav>
    ...
    <script>
        ...
        var wms = L.tileLayer.wms('http://idesc.cali.gov.co:8081/geoserver/wms?service=WMS&version=1.1.0', 
        {
        ...
        var ImmediateSubAction = L.Toolbar2.Action.extend({
                ...
                options: {
                    toolbarIcon: {
                        html: 'Visualizar Reportes Semestral',
                        tooltip: 'Visualizar'
                    }
                },
                addHooks: function() {
                      var flag_clustter=false;
                    alert( "A continuación se muestran los reportes desde la fecha 1/06/2020:" );
