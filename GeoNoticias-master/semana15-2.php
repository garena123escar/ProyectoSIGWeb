                    ...
                    <div class="row">
                          <div class=" col-xs-12  col-sm-12 col-md-12 col-lg-12 text-center">
                                      <a class="logo" href=""> <img src="img/logo(1).png"/>   
                                        <a style=" position: relative;left: 170px" href="#ventana-vision" data-toggle="modal" data-target="#exampleModal" aria-haspopup="false" aria-expanded="false">¿Quienes sómos?</a></a>
                         
                             

 								 <ul class="pull-left"></ul>
                               <a style=" position: relative;left: 170px" id="mapa_clustert" href="#mapa_clustert"><i ></i>Reportes del día</a>

                               <a style=" position: relative;left: 170px" id="mapa_cluster" href="#mapa_cluster"><i ></i>Todos los reportes</a>
                               <a style=" position: relative;left: 170px" id="boton_ruteo" href="UltimasNoticiasAdm.php"><i ></i>Ultimos reportes</a>

                               <a style=" position: relative;left: 170px" class="tex-white" id="boton_Editar" href='form_update.php'><i class="fa fa-fw fa-pencil text-white"></i> Editar reportes</a>
                               <a style="position: relative;left: 170px" class="tex-white" id="boton_Eliminar" href="form_delete.php"><i class="fa fa-fw fa-trash text-white"></i> Borrar reportes</a>
                            <ul class="pull-left"></ul>
                              <a style="position: relative;left: 170px" href="InicioSesion2.html?op=salir"><i ></i>Cerrar Sesión</a>
                              <a style="position: relative;left: 170px" id="boton_Editar_usuario" href="form_update_admn.php"><i class="fa fa-fw fa-user "></i>Perfil</a>
...
<div id="mySidenav" class="sidenav" style="z-index: 2;">
  ...
  <button id="borrar_map" class="btn btn-lg btn-primary btn-block" onClick="location.href='javascript:location.reload()';">Borrar todo	 </button><br>	<br><br><br><br><br><br>	

		 <div class="btn-group" role="group">
		    <button id="btnGroupDrop1" type="button" class="btn btn-lg btn-primary btn-block" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp Reportar 	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp 	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp
		    </button>
		    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
			<input type="button" class="dropdown-item" id="boton_reporte_cliente1" value="Insertar Noticia en mi pos "class="btn btn-danger bt-sm" >
			<input type="button" class="dropdown-item" id="boton_reporte_cliente" value="Insertar reporte "class="btn btn-danger bt-sm" >
		    </div>
		  </div><br><br>

		  <div class="btn-group" role="group">
		    <button id="btnGroupDrop2" type="button" class="btn btn-danger dropdown-toggle btn-lg" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp Conteos &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		    </button>
		       
		    <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
			<input type="button" class="dropdown-item" id="boton_conteo1" onClick="location.href='conteo_comuna.php';"  value="Reportes por Comunas"class="btn btn-danger bt-sm" >
			<input type="button" class="dropdown-item" id="boton_conteo" onClick="location.href='conteo_barrio.php';"  value="Reportes por Barrio "class="btn btn-danger bt-sm" >
			<input type="button" class="dropdown-item" id="boton_conteo" onClick="location.href='conteo_tipoAdm.php';"  value="Reportes por Tipo "class="btn btn-danger bt-sm" >
		    </div>
		  </div><br><br>

		   <div class="btn-group" role="group">
		    <button id="btnGroupDrop3" type="button" class="btn btn-danger dropdown-toggle btn-lg btn-block" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		    &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp Herramientas  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp  &nbsp  &nbsp
		    </button><br>
		   ...
		   <div class="btn-group" role="group">
		    <button id="btnGroupDrop4" type="button" class="btn btn-danger dropdown-toggle btn-lg" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp Tipo Reportes 	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp </button>
		    <div class="dropdown-menu" aria-labelledby="btnGroupDrop4">
				<input  type="button" class="dropdown-item" id="mapa_reporte2" value="Reporte por usuario"class="btn border-warning" >
				<input  type="button" class="dropdown-item" id="mapa_reporte3" value="Reporte por tipo"class="btn border-warning" >
				<input  type="button" class="dropdown-item" id="mapa_reporte" value="Reporte por comunas"class="btn border-warning" >
		    </div>
  </div>
...
<div class="row">
<div class="container">		
<div class="display-4 col-12 col-sm-12 col-md-12 col-lg-1 col-xl-12 text-center"> 
<div id="mapid" style="height:680px;max-width:1200px ; max-height:680px;z-index:1;"></div>
