          ...
          <div class="container-fluid">
                    <div class="row">
                          <div class=" col-xs-12  col-sm-12 col-md-12 col-lg-12 text-center">
                               ...
                               <a style=" position: relative;left: 170px" id="boton_ruteo" href="UltimasNoticiasAdm2.php"><i ></i>Ultimos reportes</a>

                               <a style=" position: relative;left: 170px" class="tex-white" id="boton_Editar" href='form_update2.php'><i class="fa fa-fw fa-pencil text-white"></i> Editar reportes</a>
                            <ul class="pull-left"></ul>
                              <a style="position: relative;left: 170px" href="InicioSesion3.html?op=salir"><i ></i>Cerrar Sesión</a>
                              <a style="position: relative;left: 170px" id="boton_Editar_usuario" href="form_update_usu2.php"><i class="fa fa-fw fa-user "></i>Perfil</a>
...
<div id="mySidenav" class="sidenav" style="z-index: 2;">
  ...
  <button id="borrar_map" class="btn btn-lg btn-primary btn-block" onClick="location.href='javascript:location.reload()';">Borrar todo	 </button><br>	<br><br>	

	

		  <div class="btn-group" role="group">
		    <button id="btnGroupDrop2" type="button" class="btn btn-danger dropdown-toggle btn-block btn-lg" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<input type="button" class="dropdown-item" id="boton_conteo1" onClick="location.href='conteo_comuna2.php';"  value="Reportes por Comunas"class="btn btn-danger bt-sm" >
			<input type="button" class="dropdown-item" id="boton_conteo" onClick="location.href='conteo_TipoAdm2.php';"  value="Reportes por Tipo "class="btn btn-danger bt-sm" >
		    </div>
		  </div><br><br>
