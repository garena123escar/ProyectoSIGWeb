...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <!--<div class="display-1 col-6 col-sm-6 col-md-6 col-lg-6 col-xl-8 text-center"></div>-->
    ...
    <a class="navbar-brand text" href='semana15-3.php?logueado=si'>Volver al Geovisor</a>
 ...
 <li class="active"><a href="#ventana-vision" class=" nav-link btn btn-outline-danger btn-lg" data-toggle="modal" data-target="#exampleModal" aria-haspopup="true" aria-expanded="false">¿Quienes sómos?</a></li> 
      ...
      <li class="active"><a id="boton_quienes_somos" href="index.html?op=salir" class="btn btn-outline-danger btn-lg">Cerrar sesión</a></li>
      		<li class="active  ">	<a class="btn btn-outline-danger btn-lg	" href="form_update2.php">Volver al Listado de Reportes (Actualizar)</a></li>
